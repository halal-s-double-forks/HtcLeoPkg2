...
typedef struct block_dev_desc {
	...
	unsigned long	(*block_read)(unsigned long start, unsigned long blkcnt, void *buffer);
	unsigned long	(*block_write)(unsigned long start, unsigned long blkcnt, const void *buffer);
	unsigned long   (*block_erase)(unsigned long start, unsigned long blkcnt);
