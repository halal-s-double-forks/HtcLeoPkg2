# @file
# Script to Build Example Apple UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("HtcLeoPkg",)
    ArchSupported = ("ARM",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('HtcLeo', 'gcc_arm_linux', 'edk2-build')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("HtcLeoPkg/HtcLeoPkg.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def AddCommandLineOptions(self, parserObj):
        ...
        # architectures.
        parserObj.add_argument('-a', "--arch", dest="build_arch", type=str, default="ARM",
            help="Optional - CSV of architecture to build.  ARM is used for PEI and "
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "HtcLeoPkg/HtcLeoPkg.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "HtcLeo", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "HtcLeoPkg/HtcLeoPkg.dsc", "Platform Hardcoded")
